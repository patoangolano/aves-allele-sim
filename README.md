# aves-allele-sim
Pipeline Windows‑nativo para preparar VCFs, anotar variantes de Gallus gallus via Ensembl VEP REST, intersectar regiões regulatórias e gerar relatórios.  Descrição completa
